                                        ...
                                        <form method="post" action="search">
                                            ...
                                            <div class="col-md-4">
                                                <div class="product-price-range">
                                                    ...
                                                    <input type="number" value="${price}" name="price" id="price" placeholder="Max">
                                                    <br>
                                    ...
                                    <c:forEach var="i" begin="1" end="${totalPages}">
                                        <c:choose>
                                            <c:when test="${currentPage == i}">
                                                ...
                                                <c:otherwise>
                                                <li class="page-item"><a class="page-link" href="search?page=${i}&sortBy=${sortBy}&sortOrder=${sortOrder}&cid=${cid}">${i}</a></li>
                                                </c:otherwise>
                                            </c:choose>
                                        </c:forEach>
                                </ul>
